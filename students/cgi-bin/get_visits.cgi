...
my $sql="select pupils.FIO, visits.* from pupils, visits where pupils.Num_dogovor=visits.PUPILS_NUM_DOGOVOR and visits.PUPILS_NUM_DOGOVOR=?";
$sth=$dbh->prepare($sql);
$sth->execute($num_dog);
...
my $sql1="select pupils.FIO, visits.* from pupils, visits where pupils.Num_dogovor=visits.PUPILS_NUM_DOGOVOR and visits.PUPILS_NUM_DOGOVOR=?";
