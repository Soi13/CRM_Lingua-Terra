...
my $sql="select COUNT(*) from pays_without_group where PUPILS_NUM_DOGOVOR=?";
$sth=$dbh->prepare($sql);
$sth->execute($stud);
...
my $sql1="select ID, OPL_SUMM, DATE_OF_PAY, STATUS, NOTES from pays_without_group where PUPILS_NUM_DOGOVOR=?";
