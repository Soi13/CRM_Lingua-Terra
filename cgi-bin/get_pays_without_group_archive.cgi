...
my $sql="select COUNT(*) from pays_without_group_archive where PUPILS_NUM_DOGOVOR=?";
$sth=$dbh->prepare($sql);
$sth->execute($stud);
...
my $sql1="select OPL_SUMM, DATE_OF_PAY, STATUS, NOTES from pays_without_group_archive where PUPILS_NUM_DOGOVOR=?";
