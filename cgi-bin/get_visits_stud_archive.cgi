...
my $sql="select * from visits_archive where visits_archive.PUPILS_NUM_DOGOVOR=?";
$sth=$dbh->prepare($sql);
$sth->execute($num_dog);
...
my $sql1="select * from visits_archive where visits_archive.PUPILS_NUM_DOGOVOR=?";
