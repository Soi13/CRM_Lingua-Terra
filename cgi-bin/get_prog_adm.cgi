...
Encode::from_to($prog_name, 'utf-8', 'cp1251'); #Декодируем переданнуюстроку из utf8 в cp1251 (Windows-1251)

#Если программа определена, передана и она не равна 0, то выполняем поиск
...
else #Иначе программа не определена, не передана и она равна 0, то показываем весь список программ
{
my $offset=($page-1)*$rows;
