...
if (defined($formLogin) && defined($formPass)) {
       ...
       function send_message() {
        ...
        \$.ajax({
          ...
          data: msg,
          success: function(res) { \$.messager.alert('Информация',res.result,'info'); if (res.result=="Сообщение отправлено успешно!") {\$('#fm_message').form('clear');}},
          error: function() {alert("did not work");}
        });        
       }
       </script>
...
HTML1
        ...
        <div data-options="region:'center',title:'Рабочая область - Техническая поддержка. Пользователь: $formLogin'">
         ...
         <div style="margin-left:10px; margin-top:50px;">      
           <label><b>Текст ссобщения:</b></label>
           <br />
           <textarea name="TEXT_OF_DOCUMENT" id="TEXT_OF_DOCUMENT" rows="20" cols="80"></textarea>               
         </div>        
         <div style="margin-left:45%; margin-top:10px;;">
           <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-ok" onclick="send_message()" style="width:200px">Отправить</a>
         </div>
        </div>
        </form>
