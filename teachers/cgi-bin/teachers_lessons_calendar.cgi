...
if (defined($formLogin) && defined($formPass)) {
	...
	function init() {
		...
		scheduler.load("get_calendar_lessons_groups.cgi?SID=$SID","json");
...
HTML1
        ...
        <div data-options="region:'center',title:'Рабочая область - Календарь/Расписание. Пользователь: $formLogin'">
