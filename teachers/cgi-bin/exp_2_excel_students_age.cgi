...
$worksheet->write(1, 1, decode('windows-1251', "Студенты по возрасту"), $format);
...
$worksheet->write(3, 2, decode('windows-1251', "Дата рождения"), $format_tab);
$worksheet->write(3, 3, decode('windows-1251', "ФИО преподавателя"), $format_tab);
$worksheet->write(3, 4, decode('windows-1251', "Программа"), $format_tab);
$worksheet->write(3, 5, decode('windows-1251', "Филиал"), $format_tab);
...
my $ans="Отчет сформирован! <a href=\"../reports/report_students_age_$hour$min$sec.xls\">Открыть отчет</a>";
