...
$worksheet->write(1, 1, decode('windows-1251', "Должники за ".$period." ".$year), $format);
...
$worksheet->write(2, 0, decode('windows-1251', "Преподаватель: ".$res_lab[1]), $format_tech) if (length($label)>0);
