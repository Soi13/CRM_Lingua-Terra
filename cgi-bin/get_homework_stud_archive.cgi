...
my $sql="select COUNT(*) from topic_homework_archive where PUPILS_NUM_DOGOVOR=?";
$sth=$dbh->prepare($sql);
$sth->execute($num_dog);
...
my $sql1="select * from topic_homework_archive where PUPILS_NUM_DOGOVOR=?";
