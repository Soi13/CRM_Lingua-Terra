...
my $sql="select ID as 'id', TEXT_MESSAGE as 'text', START_DATE as 'start_date', END_DATE as 'end_date' from calendar_pupils_archive where PUPILS_NUM_DOGOVOR=? and START_DATE between ? and ? and END_DATE between ? and ?";
$sth=$dbh->prepare($sql);
