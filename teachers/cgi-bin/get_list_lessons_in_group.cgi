...
my $sql="select COUNT(*) from lessons_list, lessons where lessons_list.UUID_LESSONS=lessons.UUID and lessons.GROUP_ID=?";
$sth=$dbh->prepare($sql);
$sth->execute($gr);
...
my $sql1="select lessons_list.ID, weekdays.WEEK_DAY, lessons_list.DATE_LESSON, lessons_list.TIME_BEGIN, lessons_list.TIME_END from lessons_list, lessons, weekdays where lessons_list.WEEK_DAY=weekdays.DAY_NUM and lessons_list.UUID_LESSONS=lessons.UUID and lessons.GROUP_ID=?";
