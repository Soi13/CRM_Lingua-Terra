...
my $sql="select COUNT(*) from feedback_lessons_archive where PUPILS_NUM_DOGOVOR=?";
$sth=$dbh->prepare($sql);
$sth->execute($n_dog);
...
my $sql1="select ID, TOPIC, TEXT_FEEDBACK, DATETIME_CREATE from feedback_lessons_archive where PUPILS_NUM_DOGOVOR=?";
