...
my $sql="select * from past_academ_years_visits_archive where PAST_ACADEM_YEARS_UUID=?";
$sth=$dbh->prepare($sql);
$sth->execute($uuid);
...
my $sql1="select * from past_academ_years_visits_archive where PAST_ACADEM_YEARS_UUID=?";
