...
my $sql="select COUNT(*) from groups_students_archive where PUPILS_NUM_DOGOVOR=?";
$sth=$dbh->prepare($sql);
$sth->execute($id);
...
my $sql1="select START_DATE, END_DATE, PRICE_COURSE, BEGIN_STUDY from groups_students_archive where PUPILS_NUM_DOGOVOR=?";
