...
if (defined($formLogin) && defined($formPass)) {
    ...
    if ($EXPORT_FILES_BANK_FINANCE==1) #Смотрим имеет ли доступ пользователь к модулю "Экспорт файлов в банк".
    {
...
HTML1
        ...
        <div data-options="region:'center',title:'Рабочая область - Экспорт файлов в банк. Пользователь: $formLogin'">

        <form id="fm_bank_exp" novalidate>
        <div class="exp_bank">
               	<label>Сформировать список для банка с нулевыми суммами:</label>
               	<input id="LIST_STUD_NULL_SUMM" name="LIST_STUD_NULL_SUMM" class="easyui-switchbutton" value="1" data-options="onText:'Да',offText:'Нет'">
	        <br />
	       	<label>Сформировать список для банка:</label>
               	<input id="LIST_STUD" name="LIST_STUD" class="easyui-switchbutton" value="1" data-options="onText:'Да',offText:'Нет'">
               	</div>
	</form>
	<div style="margin-left:200px;">
               	<a href="javascript:void(0)" class="easyui-linkbutton c6" iconCls="icon-ok" onclick="make_file()" style="width:120px">Сформировать</a>
	       </div>
