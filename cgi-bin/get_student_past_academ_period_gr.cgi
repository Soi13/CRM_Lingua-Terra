...
my $sql="select COUNT(*) from past_academ_years_group_data where PAST_ACADEM_YEARS_UUID=?";
$sth=$dbh->prepare($sql);
...
my $sql1="select * from past_academ_years_group_data where PAST_ACADEM_YEARS_UUID=?";
