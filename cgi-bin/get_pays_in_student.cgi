...
my $sql1="select ID, PERIOD, SUMM_4_OPL, OPL_SUMM, DATE_OF_PAY, STATUS from pays where PUPILS_NUM_DOGOVOR=?  order by (SUBSTRING_INDEX(PERIOD, '.', -1)+0), (SUBSTRING_INDEX(PERIOD, '.', 1)+0)";
