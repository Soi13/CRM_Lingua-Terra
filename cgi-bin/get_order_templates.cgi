...
my $sql1="select document_templates.*, kind_doc.NAME as KND_DOC from document_templates, kind_doc where document_templates.KIND_DOCUMENT=kind_doc.ID and document_templates.TYPE_DOCUMENT=5 order by $sort $order";
