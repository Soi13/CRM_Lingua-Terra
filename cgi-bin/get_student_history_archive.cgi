...
my $sql="select COUNT(*) from history_students_archive where PUPILS_NUM_DOGOVOR=?";
$sth=$dbh->prepare($sql);
$sth->execute($num_dog);
...
my $sql1="select DATETIME_CREATE, TEXT from history_students_archive where PUPILS_NUM_DOGOVOR=?";
