...
my $sql="select COUNT(*) from past_academ_years_topic_homework where PAST_ACADEM_YEARS_UUID=?";
$sth=$dbh->prepare($sql);
$sth->execute($uuid);
...
my $sql1="select PERIOD, DATE_LESSON, TOPIC, HOME_WORK from past_academ_years_topic_homework where PAST_ACADEM_YEARS_UUID=?";
